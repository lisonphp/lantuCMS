...
<li id="tab_setting_4" onclick="SwapTab('setting','on','',6,4);">栏目SEO标签</li>
...
<table width="100%" class="table_form ">
	...
	<tr>
        ...
        <td><input type="text" name="info[catdir]" id="catdir" class="input-text" value="<?php echo $catdir;?>">
	...
	<tr>
      ...
      <tr>
        <th>副标题：</th>
        <td>
		<textarea name="info[subtitle]" maxlength="255" style="width:300px;height:60px;"><?php echo $subtitle;?></textarea>
		</td>
      </tr>
	<tr>
      ...
      <tr>
        <th>描述2：</th>
        <td>
		<textarea name="info[descriptions]" maxlength="255" style="width:300px;height:60px;"><?php echo $descriptions;?></textarea>
		</td>
      </tr>
	 <tr>
      <th>是否审核：</th>
...
<tr>
     <th><img src="/statics/images/icon/gear_disable.png">是否隐藏：</th>
      <td>
	  <input type='radio' name='info[ismenu]' value='0' <?php if(!$ismenu) echo 'checked';?>> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type='radio' name='info[ismenu]' value='1' <?php if($ismenu) echo 'checked';?>> <?php echo L('no');?></td>
    </tr>
