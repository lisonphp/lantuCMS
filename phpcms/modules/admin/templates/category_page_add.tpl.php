...
<table width="100%" class="table_form ">
      ...
      <td>
	  <input type='radio' name='setting[ishtml]' value='1' checked="checked" onClick="$('#category_php_ruleid').css('display','none');$('#category_html_ruleid').css('display','')"> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type='radio' name='setting[ishtml]' value='0' onClick="$('#category_php_ruleid').css('display','');$('#category_html_ruleid').css('display','none')"> <?php echo L('no');?>
	  </td>
    </tr>
	
	<tr>
      <th><?php echo L('urlrule_url');?>：</th>
      <td><div id="category_php_ruleid" style="display:block;">
	<?php
		echo form::urlrule('content','category',0,$setting['category_ruleid'],'name="category_php_ruleid"');
	?>
	</div>
	<div id="category_html_ruleid" style="display:block;">
	<?php
