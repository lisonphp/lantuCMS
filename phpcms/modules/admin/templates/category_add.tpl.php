...
<table width="100%" class="table_form ">
 <tr>
	...
	<tr id="catdir_tr">
        ...
        <td><input type="text" name="info[catdir]" id="catdir" class="input-text" value="">
        <span>例如：www.abc.com/xyz，其中“xyz”作为此英文目录</span></td>
      </tr>
	<tr>
     ...
     <tr>
        <th>副标题：</th>
        <td>
		<textarea name="info[subtitle]" maxlength="255" style="width:300px;height:60px;"><?php echo $description;?></textarea>
		</td>
      </tr>
	<tr>
	...
	<tr>
        <th>描述2：</th>
        <td>
		<textarea name="info[descriptions]" maxlength="255" style="width:300px;height:60px;"><?php echo $description;?></textarea>
		</td>
      </tr>
	 <tr>
      <th>是否审核：</th>
...
<tr>
     <th><img src="/statics/images/icon/gear_disable.png">是否隐藏：</th>
      <td>
	  <input type='radio' name='info[ismenu]' value='0' > <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type='radio' name='info[ismenu]' value='1' checked > <?php echo L('no');?></td>
    </tr>
</table>
...
<table width="100%" class="table_form ">
      ...
      <td>
	  <input type='radio' name='setting[ishtml]' value='1' checked="checked" onClick="$('#category_php_ruleid').css('display','none');$('#category_html_ruleid').css('display','');$('#tr_domain').css('display','');"> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type='radio' name='setting[ishtml]' value='0'  onClick="$('#category_php_ruleid').css('display','');$('#category_html_ruleid').css('display','none');$('#tr_domain').css('display','none');"> <?php echo L('no');?>
	  </td>
    </tr>
	<tr>
      <th><?php echo L('html_show');?>：</th>
      <td>
	  <input type='radio' name='setting[content_ishtml]' value='1' checked="checked" onClick="$('#show_php_ruleid').css('display','none');$('#show_html_ruleid').css('display','')"> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type='radio' name='setting[content_ishtml]' value='0' onClick="$('#show_php_ruleid').css('display','');$('#show_html_ruleid').css('display','none')"> <?php echo L('no');?>
	  </td>
    </tr>
	<tr>
      <th><?php echo L('category_urlrules');?>：</th>
      <td><div id="category_php_ruleid" >
	<?php
...
<tr>
      ...
      <td>
	  <input type='radio' name='setting[create_to_html_root]' value='1' checked> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type='radio' name='setting[create_to_html_root]' value='0'> <?php echo L('no');?>
...
<table width="100%" class="table_form ">
<tr>
  <th width="200" style="display:none;"><?php echo L('available_styles');?>：</th>
...
<script language="JavaScript">
	...
	<?php if(isset($res_site) && !empty($res_site)) echo "load_file_list('".$res_site."')"?>
</script>