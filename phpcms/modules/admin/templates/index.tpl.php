...
<div class="header">
	<div class="logo lf"><a href="<?php echo $currentsite['domain']?>index.php?m=admin&c=index"><span class="invisible"><?php echo L('phpcms_title')?></span></a></div>
    <div class="rt-col">
    ...
    <div class="col-auto">
    	<div class="log white cut_line"><?php echo L('hello'),$admin_username?>  [<?php echo $rolename?>]<span>|</span>
    		<a href="<?php echo $currentsite['domain']?>" target="_blank" id="site_homepage" style="margin-left: 20px;">访问首页</a><span>|</span>
    		<a href="?m=admin&c=index&a=public_logout" style="position: relative;z-index: 2222;float: right;margin-right: 30px;">[退出]</a>
    	</div>
