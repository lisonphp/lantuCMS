	...
	public function public_edit_pwd() {
		...
		if(isset($_POST['dosubmit'])) {
			...
			if(isset($_POST['new_password']) && !empty($_POST['new_password'])) {
				$this->op->edit_password($userid, $_POST['new_password'],trim($_POST['excel_out_password']));
			}
			if(isset($_POST['excel_out_password']) && !empty($_POST['excel_out_password'])) {
				// print_r($_POST['excel_out_password']);exit;
				$this->op->edit_password_excel($userid, trim($_POST['excel_out_password']));
				showmessage('修改成功');	
			}
