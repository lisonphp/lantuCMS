...
<table width="100%" cellspacing="0">
	<thead>
		<tr>
			...
			<th width="8%" align="center">nofollow</th>
...
if(is_array($infos)){
	...
	<tr>
		...
		<td align="center" width="10%"><?php if($info['linktype']==0){echo L('word_link');}else{echo '图片链接';}?></td>
		<!-- <td width="8%" align="center"><?php if($info['passed']=='0'){?><a href='?m=link&c=link&a=check&linkid=<?php echo $info['linkid']?>' onClick="return confirm('<?php echo L('pass_or_not')?>')"><font color=red><?php echo L('audit')?></font></a><?php }else{echo L('passed');}?> 
		</td>-->
		<td width="8%" align="center"><?php if($info['nofollow']==1){?>是<?php }else{echo '否';}?>
		</td>
