...
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
	...
	<input id="linktypeb" type="radio" name="link[linktype]" value="0" <?php if($linktype == 0){echo "checked";}?> style="border:0" onclick="$('#logolink').hide()" class="radio_style">
	<label for="linktypeb" style="cursor: pointer;">文字链接</label>
		<input id="linktypea" name="link[linktype]" type="radio" value="1" <?php if($linktype == 1){echo "checked";}?> style="border:0" onclick="$('#logolink').show()" class="radio_style">
	<label for="linktypea" style="cursor: pointer;">图片链接</label>
		</td>
	</tr>
	...
	<tr>
		<th>是否nofollow：</th>
		<td>
		<label for="nofa" style="cursor: pointer;"><input id="nofa" name="link[nofollow]" type="radio" value="1" <?php if($nofollow==1){echo "checked";}?>> 是</label>
		<label for="nofb" style="margin-left: 20px;cursor: pointer;"><input id="nofb" name="link[nofollow]" type="radio" value="0" <?php if($nofollow==0){echo "checked";}?>> 否</label></td>
	</tr>
