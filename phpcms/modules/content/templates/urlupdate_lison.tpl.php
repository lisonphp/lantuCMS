...
<form action="?m=content&c=create_html&a=urlupdate" method="post" name="myform">
...
<?php echo $string;?>
	...
	更新站点域名URL <input type="button" name="dosubmit1" value=" <?php echo L('submit_start_update');?> " class="button" onclick="myform.type.value='all';myform.submit();">
	</form>
</table>
