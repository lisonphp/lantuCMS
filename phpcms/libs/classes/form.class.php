...
class form {
	 ...
	 */
	public static function editor7777($textareaid = 'content', $toolbar = 'basic', $module = '', $catid = '', $color = '', $allowupload = 0, $allowbrowser = 1,$alowuploadexts = '',$height = 200,$disabled_page = 0, $allowuploadnum = '10') {
		$str ='';
	...
	public static function editor($textareaid = 'content', $toolbar = 'basic', $module = '', $catid = '', $color = '', $allowupload = 0, $allowbrowser = 1,$alowuploadexts = '',$height = 200,$disabled_page = 0, $allowuploadnum = '10') {
		$str ='';
		 if(!defined('EDITOR_INIT')) {
		         $str .= '<script type="text/javascript" src="'.JS_PATH.'ueditor1433/ueditor.config.js"></script>';
		         $str .= '<script type="text/javascript" src="'.JS_PATH.'ueditor1433/ueditor.all.js"></script>';
		         $str .= '<link rel="stylesheet" href="'.JS_PATH.'ueditor1433/themes/default/css/ueditor.css"/>';
		         define('EDITOR_INIT', 1);
		 }
		 $str .= "<script type=\"text/javascript\">\r\n";
		...
		$ext_str .= "<div id='page_title_div' style='display:none'>
